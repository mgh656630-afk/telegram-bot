...
def ask_shaza(prompt_type):
    prompts = {
        "poetry": "اكتب بيت شعر واحد فقط يحفز على العلم والنجاح، يكون بليغاً ومؤثراً.",
        "quote": "أعطني اقتباساً عالمياً ملهماً عن الإصرار مع ذكر اسم صاحب المقولة.",
        "boost": "أنتِ شهد، طالبة صيدلة وزميلة محبة. وجهي رسالة تحفيزية قصيرة جداً وقوية لطالب بكلوريا تعبان بلهجة سورية بيضاء قريبة للقلب."
    }
    try:
        response = ai_model.generate_content(prompts[prompt_type])
        return response.text
    except:
        return "خلي طموحك عالي، النجاح بيستاهل التعب! ✨"
